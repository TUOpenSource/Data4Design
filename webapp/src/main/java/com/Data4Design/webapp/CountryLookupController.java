...
public class CountryLookupController {
    ...
    public String country_page(Map<String, Object> model, @PathVariable String id) {
        ...
        /*
         * CountryInfo countryInfo = new CountryInfo(); String str_id =
         * String.valueOf(id); CountryListService country_list_service = new
         * CountryListService(); String country_name =
         * country_list_service.getCountryName(str_id); String iso_3_str =
         * country_list_service.toISO3(str_id);
         * 
         * iCountryInfoItemServices.add(new
         * AnnualPrecipitationServiceCountryInfoItem());
         ...
         * 
         * try { countryInfoWorkflow = new
         * GetCountryInfoWorkflow(iCountryInfoItemServices); countryInfo =
         * countryInfoWorkflow.GetCountryInfo(str_id); } catch (Exception e) {
         * e.printStackTrace(); }
         * 
         * for(CountryInfoItem c: countryInfo.CountryInfoItems) { model.put(c.Title,
         * c.Value); }
         */
