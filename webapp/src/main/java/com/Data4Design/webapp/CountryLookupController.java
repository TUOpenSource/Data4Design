...
public class CountryLookupController {
    ...
    public String country_page(Map<String, Object> model, @PathVariable String id) {
    	...
    	*/
        ...
        MonthlyPrecipitationServiceCountryInfoItem monthlyRainService = new MonthlyPrecipitationServiceCountryInfoItem();
        //MonthlyTemperatureService monthlyTempService = new MonthlyTemperatureService();
        ICountryInfoItemService monthlyTempService = new MonthlyTemperatureServiceCountryInfoItem();
        ...
        String rainfall = monthlyRainService.GetCountryInfoItem(iso_3_str).getValue();
        String temperature = monthlyTempService.GetCountryInfoItem(iso_3_str).Value;
        String country_list = country_list_service.getCountryListString();
        model.put("monthly_rainfall", rainfall);
        model.put("monthly_temperature",temperature);
